...
import { StartScrapingSchema, ScrapingJobParamsSchema, } from '../schemas/scraping.js';
import { NotFoundError } from '../utils/index.js';
export async function scrapingRoutes(fastify) {
    ...
    fastify.get('/scraping/jobs/active', {
        schema: {
            tags: ['scraping'],
    ...
    fastify.delete('/scraping/jobs/:id', {
        schema: {
            tags: ['scraping'],
