# Tasks: Self-Hosted Temporal Server

- [x] Add Temporal server to `docker-compose.dev.yml`
- [x] Add Temporal server to `docker-compose.prod.yml`
- [x] Update `backend` environment variables in `docker-compose.dev.yml`
